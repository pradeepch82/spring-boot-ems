...
<div> <h2>Update Employee</h2></div>

<form:form    modelAttribute="employee"  method="post"  action="${pageContext.servletContext.contextPath}/spring/update">
...
<td>${e.doj}</td>
<td>${e.pan}</td>
<td><a href="${pageContext.servletContext.contextPath}/spring/edit/${e.employeeId}"> <input type="button"  class="btn btn-success"  value="EDIT"></a></td>
<td><a href="${pageContext.servletContext.contextPath}/spring/delete?employeeId=${e.employeeId}"> <input type="button"  class="btn btn-danger"  value="DELETE"></a></td>
</tr>
</c:forEach>
